"""
SFDA — Lowrisk Scraper
=======================
Scrapes all Lowrisk medical device records from the SFDA API.
Run alongside sfda_TFA.py and sfda_GHTF.py in separate terminals.

Output : sfda_Lowrisk.csv
State  : sfda_Lowrisk_progress.json   ← resumes if script is closed
Log    : sfda_Lowrisk.log
"""
